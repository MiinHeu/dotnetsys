...
export function AudioPage() {
  ...
  return (
    <div className="vk-page mx-auto max-w-3xl text-left">
      ...
      <input className="vk-input file:mr-3 file:rounded-md file:border-0 file:bg-slate-100 file:px-3 file:py-2 file:text-sm file:font-semibold file:text-slate-700" type="file" accept=".mp3,.wav,.m4a,audio/*" disabled={busy} onChange={onFile} />
